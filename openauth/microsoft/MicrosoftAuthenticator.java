...
import base.util.openauth.microsoft.model.request.MinecraftLoginRequest;
import base.util.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import base.util.openauth.microsoft.model.request.XboxLiveLoginProperties;
import base.util.openauth.microsoft.model.request.XboxLoginRequest;
import base.util.openauth.microsoft.model.response.MicrosoftRefreshResponse;
import base.util.openauth.microsoft.model.response.MinecraftLoginResponse;
import base.util.openauth.microsoft.model.response.MinecraftProfile;
import base.util.openauth.microsoft.model.response.MinecraftStoreResponse;
import base.util.openauth.microsoft.model.response.XboxLoginResponse;
